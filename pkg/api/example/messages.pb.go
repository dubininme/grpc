...
// CreatePostRequest is the request message for creating a new tweet
type CreatePostRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Title of the tweet
	Title string `protobuf:"bytes,1,opt,name=title,proto3" json:"title,omitempty"`
	// Author ID of the tweet
	AuthorId string `protobuf:"bytes,2,opt,name=author_id,json=author_idd,proto3" json:"author_id,omitempty"`
...
// CreatePostResponse is the response message for creating a new tweet
type CreatePostResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// post_id is the ID of the created tweet
...
const file_api_example_messages_proto_rawDesc = "" +
	"\n" +
	"\x1aapi/example/messages.proto\x12*github.dubininme.grpc.protobuf.api.example\"b\n" +
	...
	"\x11ListPostsResponseB\xa0\x02\n" +
	".com.github.dubininme.grpc.protobuf.api.exampleB\rMessagesProtoP\x01Z\x0fpkg/api/example\xa2\x02\x06GDGPAE\xaa\x02*Github.Dubininme.Grpc.Protobuf.Api.Example\xca\x02*Github\\Dubininme\\Grpc\\Protobuf\\Api\\Example\xe2\x026Github\\Dubininme\\Grpc\\Protobuf\\Api\\Example\\GPBMetadata\xea\x02/Github::Dubininme::Grpc::Protobuf::Api::Exampleb\x06proto3"
...
var file_api_example_messages_proto_goTypes = []any{
	...
	(*CreatePostResponse)(nil), // 1: github.dubininme.grpc.protobuf.api.example.CreatePostResponse
	(*ListPostsRequest)(nil),   // 2: github.dubininme.grpc.protobuf.api.example.ListPostsRequest
